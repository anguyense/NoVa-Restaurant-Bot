var urlSignature = (function (exports, Base64, HmacSHA1) {
	...
	var global$f = global$g; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	var functionUncurryThis = function (fn) {
	  ...
	  return fn instanceof $Function ? NATIVE_BIND$3 ? uncurryThis$l(fn) : function () {
	...
	var fails$j = fails$l; // eslint-disable-next-line es/no-object-getownpropertysymbols -- required for testing
	...
	var isNullOrUndefined$3 = isNullOrUndefined$5; // `GetMethod` abstract operation
	...
	var ordinaryToPrimitive$1 = function (input, pref) {
	  var fn, val;
	  if (pref === 'string' && isCallable$e(fn = input.toString) && !isObject$6(val = call$e(fn, input))) return val;
	  if (isCallable$e(fn = input.valueOf) && !isObject$6(val = call$e(fn, input))) return val;
	  if (pref !== 'string' && isCallable$e(fn = input.toString) && !isObject$6(val = call$e(fn, input))) return val;
	...
	var getInternalState$3 = InternalStateModule$4.get; // eslint-disable-next-line es/no-object-defineproperty -- safe
	...
	var $Object$2 = Object; // ES3 wrong here
	...
	var indexedObject = fails$d(function () {
	  ...
	  return classof$5(it) == 'String' ? split$3(it, '') : $Object$1(it);
	} : $Object$1;
	...
	*/
	...
	var fails$b = fails$l;
	var global$6 = global$g; // babel-minify and Closure Compiler transpiles RegExp('a', 'y') -> /a/y and it causes SyntaxError
	...
	var fails$a = fails$l;
	var global$5 = global$g; // babel-minify and Closure Compiler transpiles RegExp('.', 's') -> /./s and it causes SyntaxError
	...
	var fails$9 = fails$l;
	var global$4 = global$g; // babel-minify and Closure Compiler transpiles RegExp('(?<a>b)', 'g') -> /(?<a>b)/g and it causes SyntaxError
	...
	var $TypeError$5 = TypeError; // `RegExpExec` abstract operation
	...
	var getInternalIteratorState = InternalStateModule$1.getterFor(URL_SEARCH_PARAMS_ITERATOR); // eslint-disable-next-line es/no-object-getownpropertydescriptor -- safe
